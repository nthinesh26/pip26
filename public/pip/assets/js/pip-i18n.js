...
org_mandate_heading: "Penerang Organisai Mandat / Peranan Utama",
  ...
  // Reset_pwd
reset_form_err_pwd_required: "Sila masukkan kata laluan baharu.",
reset_form_err_confirm_required: "Sila sahkan kata laluan.",
      ...
      // Reset Password
      reset_email_page_title: "Tetapkan semula kata laluan | Portal Industri Pertahanan",
      reset_email_h1: "Lupa Kata Laluan",
      reset_email_subtitle: "Sila masukkan maklumat berikut",
      reset_email_email_label: "Emel",
      reset_email_email_help: "Contoh: nama@domain.com",
      reset_email_submit: "Hantar",
      reset_email_err_required: "Sila masukkan alamat emel.",
      reset_email_err_invalid: "Sila masukkan alamat emel yang sah. Contoh: nama@domain.com",
      reset_form_page_title: "Tetapkan semula kata laluan | Portal Industri Pertahanan",
      reset_form_h1: "Tetapkan Semula Kata Laluan",
      reset_form_subtitle: "Sila masukkan kata laluan yang baharu",
      reset_form_pwd_label: "Kata Laluan Baharu",
      reset_form_pwd_help: "Minimum 8 aksara, huruf besar, huruf kecil dan nombor.",
      reset_form_confirm_label: "Sahkan Kata Laluan",
      reset_form_submit: "Hantar",
      reset_form_err_pwd_rule: "Minimum 8 aksara dengan huruf besar, kecil dan nombor.",
      reset_form_err_mismatch: "Kata laluan tidak sepadan."
...
reset_form_err_pwd_required: "Please enter a new password.",
reset_form_err_confirm_required: "Please confirm your password.",
      ...
      // Reset Password
      reset_email_page_title: "Reset password | Defence Industry Portal",
      reset_email_h1: "Forgot Password",
      reset_email_subtitle: "Please enter the following information",
      reset_email_email_label: "Email",
      reset_email_email_help: "Example: name@domain.com",
      reset_email_submit: "Submit",
      reset_email_err_required: "Please enter your email address.",
      reset_email_err_invalid: "Please enter a valid email. Example: name@domain.com",
      reset_form_page_title: "Reset password | Defence Industry Portal",
      reset_form_h1: "Reset Password",
      reset_form_subtitle: "Please enter your new password",
      reset_form_pwd_label: "New Password",
      reset_form_pwd_help: "Minimum 8 characters with uppercase, lowercase, and a number.",
      reset_form_confirm_label: "Confirm Password",
      reset_form_submit: "Submit",
      reset_form_err_pwd_rule: "Minimum 8 characters with uppercase, lowercase, and a number.",
      reset_form_err_mismatch: "Passwords do not match."
