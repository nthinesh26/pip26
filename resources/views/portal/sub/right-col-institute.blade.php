         ...
         <div class="pip-box-body">
             <div class="pip-orgmeta">
                 <div class="pip-orgmeta-row">
                     <div class="pip-orgmeta-label" data-i18n="org_org_name">NAMA SYARIKAT</div>
                     <div class="pip-orgmeta-value">
                         <div class="pip-orgmeta-strong">{{ $profile->organisation_name }}</div>
                     </div>
                 </div>
                 <div class="pip-orgmeta-row">
                     <div class="pip-orgmeta-label" data-i18n="org_established_date">NO PENDAFTARAN SSM</div>
                     <div class="pip-orgmeta-value">{{ $profile->organisation_established_date }}</div>
                 </div>
                 <div class="pip-orgmeta-row">
                    @php
                        $type = json_decode($profile->org_desciption);
                    @endphp
                     <div class="pip-orgmeta-label" data-i18n="org_org_type">TARIKH DITUBUHKAN</div>
                     <div class="pip-orgmeta-value">{{ $type->type }}</div>
                 </div>
                 ...
                 <div class="pip-orgmeta-contact">
                     ...
                     <div class="pip-orgmeta-contact-item">
                         ...
                         <span class="pip-orgmeta-contact-text">{{ $profile->organisation_website }}</span>
                     </div>
         ...
         <div class="pip-box-body">
             <ul class="pip-doc-list">
                 <li class="pip-doc-item">
                     <a class="pip-doc-link" href="/pip/%7B%7BDOC_PROFIL_SYARIKAT_URL%7D%7D" rel="noopener"
                         target="_blank">

                     </a>
                 </li>
                 <li class="pip-doc-item">
                     <a class="pip-doc-link" href="/pip/%7B%7BDOC_ISO27001_URL%7D%7D" rel="noopener" target="_blank">
