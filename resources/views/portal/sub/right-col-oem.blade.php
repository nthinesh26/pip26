         ...
         <div class="pip-box-body">
             <div class="pip-orgmeta">
                 <div class="pip-orgmeta-row">
                     <div class="pip-orgmeta-label" data-i18n="org_oem_name">NAMA SYARIKAT</div>
                     <div class="pip-orgmeta-value">
                         <div class="pip-orgmeta-strong">{{ $profile->company_name }}</div>
                     </div>
                 </div>
                 <div class="pip-orgmeta-row">
                     <div class="pip-orgmeta-label" data-i18n="org_ssm_no">NO PENDAFTARAN SSM</div>
                     <div class="pip-orgmeta-value">{{ $profile->company_registration_no }}</div>
                 </div>
                 <div class="pip-orgmeta-row">
                     <div class="pip-orgmeta-label" data-i18n="org_year_established">TARIKH DITUBUHKAN</div>
                     <div class="pip-orgmeta-value">{{ $profile->company_year_established }}</div>
                 </div>
                 @php
                     $com = [
                 ...
                 <div class="pip-orgmeta-contact">
                     ...
                     <div class="pip-orgmeta-contact-item">
                         ...
                         <span class="pip-orgmeta-contact-text">{{ $profile->company_website }}</span>
                     </div>
                 </div>
             </div>
         </div>
